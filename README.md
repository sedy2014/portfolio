...
|---------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| ![Reviewer](./genAiBook.jpg) <br> **Reviewer: Generative AI in Computer Vision** <br> Provided expert review and feedback for the Manning book *Image Generation Models*, covering diffusion models and modern generative architectures. <br> [Read the Book](https://www.manning.com/books/image-generation-models) | ![Author](./fpga_book.png) <br> **Author** <br> First Graduate-level book to implement DSP on FPGA using no textual code. <br> [Link to Book](https://www.amazon.com/Digital-Signal-Processing-Laboratory-Implementation/dp/1599425505) | ![Reviewer](./jrtip.png) <br> **Reviewer** <br> Reviewer for Real-Time Image Processing papers. <br> [Journal Link](https://link.springer.com/journal/11554) | ![NIW](./niw.png) <br> **National Interest Waiver I-140** <br> My work over the years acknowledged as of substantial intrinsic merit for national interest of the US. <br> [NIW: What is it](https://www.uscis.gov/newsroom/alerts/uscis-updates-guidance-on-eb-2-national-interest-waiver-petitions) |
| ![IEEE Senior Member](./ieee.png) <br> **IEEE Senior Member** <br> Elevation to the grade of IEEE Senior Member. <br> [IEEE](https://www.ieee.org/membership/senior/) |                                                                                             |                                                                                             |                                                                                             |
...
|--------|---------|---------|
| <br> **Independent consultant** <br> Prototyped and evaluated Python anomaly detection systems for a client's community chatbot comparing embedding/clustering against feature-engineering (sentiment/length rules), and analyzed data drift, streaming implications, model limitations, and unsupervised performance monitoring. <br> | <br> **Independent consultant** <br> Engineered an automated defect analysis system for a cloth manufacturing client, leveraging Meta AI's Segment Anything Model (SAM) and Detectron2 for precise anomaly detection. Resulted in a 20–25% boost in defect identification accuracy and significantly faster quality control. <br> | ![Medtronic](./medtronic.png) <br> **Medtronic** <br> Led project to develop a Generative AI-driven system that summarized concerns, created dashboards, and generated compliant responses, reducing FDA review cycle time by 40% and improving first-pass acceptance rates. <br> [Visit Website](https://www.medtronic.com/en-us/index.html) |
| ![ISRO](./isro.png) <br> **Indian Space Research Organization (ISRO)** <br> Engineered MTF algorithm, blind deconvolution & wavelet denoising for high PSNR gain in Cartosat-2 satellite imagery. <br> [Visit Website](https://www.isro.gov.in/) | ![Synaptics](./synaptics.png) <br> **Synaptics Audio (Now Google)** <br> Developed earbud in/out detection algorithm with hybrid ANC/ENC and AI/neural processing, boosting efficiency, cutting size/cost for enhanced audio. <br> [Visit Website](https://www.synaptics.com/) | ![Zounds Hearing](./zounds.png) <br> **Zounds Hearing** <br> Spearheaded first patient-centric tinnitus diagnostic tool with GUI integration for hearing aid platforms. <br> [Visit Website](https://www.zoundshearing.com/) |
...
### Contact Links
- [🐱 GitHub](https://github.com/sedy2014)
- [✉️ Gmail](mailto:mahotra.sidharth@gmail.com)
- [💼 LinkedIn](https://www.linkedin.com/in/sidharthmahotra/)
- [✨ Topmate](https://topmate.io/sidharth_mahotra/)
